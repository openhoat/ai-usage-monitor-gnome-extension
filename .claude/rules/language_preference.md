...
This rule applies to all conversations with Claude Code.
...
**Correct (French):**
"Je vais créer le fichier de configuration pour vous."

**Incorrect (English):**
"I will create the configuration file for you."

**Technical terms remain as-is:**
"Utilisez l'API `Gio.Subprocess` pour exécuter le script Node.js."